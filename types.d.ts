 ...
 */
type TypeNamedReexport = Position & {
    names?: Names;
};
/**
 ...
 */
export type Kind = 'async function' | 'async function*' | 'class' | 'const' | 'function' | 'function*' | 'let' | 'var';
/**
 ...
 */
export type Names = Record<string, {
    by?: string;
}>;
/**
